  ...
  return (
    <div className="flex flex-col items-center justify-center h-full ">
      ...
      <div className="flex flex-col max-w-[360px] p-4 px-6 mt-5 bg-white border rounded-md h-fit">
        <div className="mb-3 text-[26px] font-semibold">Sign in</div>
        <form>
        ...
        <button
          className="w-full p-1 pb-2 my-2 text-sm text-center border-2 shadow-sm rounded-xl hover:bg-gray-50"
          onClick={registor}
        >
